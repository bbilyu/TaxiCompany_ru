...
class Recovery_from_damage(Base,StatusMixin):
    """
    ...
    """
    __tablename__ = "Recovery_from_damages"
    ...
    def __repr__(self):
        return f"<Recovery_from_damages {self.record_id} {self.description} {self.amount}>"
